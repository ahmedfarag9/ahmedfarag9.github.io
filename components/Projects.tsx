...
function Projects({}: Props) {
  ...
  const projects = {
    1: {name:"E-Commerce-MERN-App", picture: ecommercePic, description:"Full E-commerce MERN STACK Web-app, deployed on AWS, implemented with Github Actions CI-CD pipeline, using Docker and Kubernetes.", link:"https://github.com/ahmedfarag9/ecommerce-webapp-mern-stack", preview: 'https://e-commerce-app-test.netlify.app/'},
    ...
    3: {name:"Modern Portfolio", picture: portfolioPic, description:"The one you're reading now. Built with REACT.JS & NEXT.JS Using (JavaScript, TypeScript, Framer Motion, Tailwind CSS)", link:"https://github.com/ahmedfarag9/modern-portfolio-reactjs-nextjs", preview:''},
    4: {name:"MLOPS CICD Housepricing", picture: mlopsPic, description:"A MLOPS CI-CD imlementaion of a Linear Regression Machine Learning Model that predicts house pricing based on various features.", link:"https://github.com/ahmedfarag9/mlops-cicd-bostonhousepricing", preview: ''},
    5: {name:"Airbyte Airflow Intergration", picture: airbyteAirflowPic, description:"An Airbyte/Airflow Api integration - Airbyte handles the Api connection & Airflow does the orchestration.", link:"https://github.com/ahmedfarag9/airbyte-airflow-api-intergration", preview: ''},
